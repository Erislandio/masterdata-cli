        ...
        try {
            ...
            if (array.length) {
                ...
                if (selectedAccount) {
                    ...
                    const confirm = await prompt.confirm(`${warning} Are you sure you want to delete the account: ${print.colors.bold.yellow(selectedAccount.name)}!`, false);
                    ...
                    return api.delete<IDeleteResponse>('/v1/user/account', {}, {
                        data: {
                        ...
                        return print.success(`Account ${selectedAccount.name} removed successfully!`)
                ...
                if (accounts.length === 1) {
                    ...
                    const confirm = await prompt.confirm(`${warning} Are you sure you want to delete the account: ${print.colors.bold.yellow(accounts[0].name)}!`, false);
                ...
                return prompt.ask<ISelectAccount>([{
                    ...
                    return api.delete<IDeleteResponse>('/v1/user/account', {}, {
                        ...
                        return print.success(`Account ${nameAccount} removed successfully!`)
